...
$rcmail_config['identiteam'] =
    array(
        ...
        'ldap' => array(
            ...
            'use_at_creation' => true,                          // Substitute email in identity form
            'check_at_creation' => true,                        // Check domain part of email at identity creation
            'check_at_update' => true,                          // or update
        ),
